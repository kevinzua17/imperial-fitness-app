...
def get_logo(db: Session = Depends(get_db)):
    ...
    return {"logo_url": row.value if row else settings.default_logo_url}
...
def get_branding(db: Session = Depends(get_db)):
    ...
    return {
        "gym_logo_url": values.get("gym_logo_url", settings.default_logo_url),
        "login_background_url": values.get("login_background_url", "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1800&auto=format&fit=crop&q=80"),
