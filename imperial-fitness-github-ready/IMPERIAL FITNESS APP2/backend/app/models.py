...
class User(Base):
    ...
    eating_pattern: Mapped[str | None] = mapped_column(String(30), nullable=True)
    dietary_preferences: Mapped[str] = mapped_column(Text, default="")
    excluded_foods: Mapped[str] = mapped_column(Text, default="")
    food_allergies: Mapped[str] = mapped_column(Text, default="")
    food_intolerances: Mapped[str] = mapped_column(Text, default="")
    medical_conditions: Mapped[str] = mapped_column(Text, default="")
    medications: Mapped[str] = mapped_column(Text, default="")
    nutrition_reviewed_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    nutrition_reviewed_by: Mapped[int | None] = mapped_column(ForeignKey("users.id"), nullable=True)
