-- Módulo Reto Camino Imperial 8 Semanas.
-- Agrega configuración comercial, garantía condicionada y seguimiento por participante.
-- Ejecutar una sola vez después de 023_produccion_500_pagos_urgencia.sql.
