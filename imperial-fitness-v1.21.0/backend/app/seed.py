...
def run() -> None:
    ...
    production_override = os.getenv("ALLOW_PRODUCTION_DEMO_SEED", "")
    if settings.app_env == "production" and production_override != "I_UNDERSTAND_THIS_CREATES_DEMO_USERS":
        raise RuntimeError(
            "El seed demo está bloqueado en producción porque crea usuarios con contraseñas conocidas. "
            "Crea las cuentas reales desde el flujo administrativo."
        )
