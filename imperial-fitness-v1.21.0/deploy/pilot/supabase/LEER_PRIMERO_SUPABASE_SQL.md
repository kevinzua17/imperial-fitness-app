...
Para una instalación nueva en Supabase, el archivo base es:
...
6. Presionar **Run**.
7. Continuar con todos los módulos en el orden de `backend/supabase/DEPLOY_ORDER.md`.
8. Finalizar con `11_PRELANZAMIENTO_ACTIVIDAD_ANALITICAS.sql` y `01_VERIFICAR_INSTALACION.sql`.
